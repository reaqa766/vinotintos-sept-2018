...
@Component({
  selector: 'app-player-listte',
  templateUrl: './player-listte.component.html',
  styleUrls: ['./player-listte.component.css']
})
export class PlayerListteComponent implements OnInit {
